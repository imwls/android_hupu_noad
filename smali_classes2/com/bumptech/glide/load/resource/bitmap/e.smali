...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e;->e:Ljava/util/Set;
    ...
    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e;->f:Ljava/util/Queue;

    .line 38
    new-instance v0, Lcom/bumptech/glide/load/resource/bitmap/e$1;

    invoke-direct {v0}, Lcom/bumptech/glide/load/resource/bitmap/e$1;-><init>()V

    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e;->a:Lcom/bumptech/glide/load/resource/bitmap/e;

    .line 54
    new-instance v0, Lcom/bumptech/glide/load/resource/bitmap/e$2;

    invoke-direct {v0}, Lcom/bumptech/glide/load/resource/bitmap/e$2;-><init>()V

    sput-object v0, Lcom/bumptech/glide/load/resource/bitmap/e;->b:Lcom/bumptech/glide/load/resource/bitmap/e;

    .line 72
    new-instance v0, Lcom/bumptech/glide/load/resource/bitmap/e$3;

    invoke-direct {v0}, Lcom/bumptech/glide/load/resource/bitmap/e$3;-><init>()V
...
.method private a(IIIII)I
    ...
    .line 192
    :cond_2
    invoke-virtual {p0, p3, p2, p4, p5}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(IIII)I
    ...
    .line 194
    :cond_3
    invoke-virtual {p0, p2, p3, p4, p5}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(IIII)I
...
.method private a(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;IIILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
    .locals 6

    .prologue
    .line 211
    invoke-static {p1, p8}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Ljava/io/InputStream;Lcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap$Config;
    ...
    :cond_0
    invoke-static {p1}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Ljava/io/InputStream;)Z
    ...
    .line 218
    invoke-interface {p4, v1, v2, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/c;->b(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object v0

    invoke-static {p3, v0}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Landroid/graphics/BitmapFactory$Options;Landroid/graphics/Bitmap;)V

    .line 220
    :cond_1
    invoke-static {p1, p2, p3}, Lcom/bumptech/glide/load/resource/bitmap/e;->b(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
...
.method private static a(Landroid/graphics/BitmapFactory$Options;)V
    ...
    .prologue
    .line 367
    invoke-static {p0}, Lcom/bumptech/glide/load/resource/bitmap/e;->b(Landroid/graphics/BitmapFactory$Options;)V

    .line 368
    sget-object v1, Lcom/bumptech/glide/load/resource/bitmap/e;->f:Ljava/util/Queue;

    monitor-enter v1

    .line 369
    :try_start_0
    sget-object v0, Lcom/bumptech/glide/load/resource/bitmap/e;->f:Ljava/util/Queue;
...
.method private static a(Ljava/io/InputStream;)Z
    ...
    .line 234
    sget-object v1, Lcom/bumptech/glide/load/resource/bitmap/e;->e:Ljava/util/Set;
...
.method private static b(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)Landroid/graphics/Bitmap;
    .locals 5
    ...
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/f/g;->mark(I)V
    ...
    .line 333
    invoke-virtual {p0}, Lcom/bumptech/glide/f/g;->reset()V
    :try_end_0
...
.method private static declared-synchronized b()Landroid/graphics/BitmapFactory$Options;
    ...
    .prologue
    .line 355
    const-class v1, Lcom/bumptech/glide/load/resource/bitmap/e;

    monitor-enter v1

    :try_start_0
    sget-object v2, Lcom/bumptech/glide/load/resource/bitmap/e;->f:Ljava/util/Queue;
    ...
    .line 360
    invoke-static {v0}, Lcom/bumptech/glide/load/resource/bitmap/e;->b(Landroid/graphics/BitmapFactory$Options;)V
    :try_end_2
...
.method public a(Ljava/io/InputStream;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;IILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
    .locals 20
    ...
    .line 109
    invoke-virtual/range {v16 .. v16}, Lcom/bumptech/glide/f/a;->c()[B
    ...
    .line 111
    invoke-static {}, Lcom/bumptech/glide/load/resource/bitmap/e;->b()Landroid/graphics/BitmapFactory$Options;
    ...
    .line 119
    invoke-static {v8}, Lcom/bumptech/glide/f/c;->a(Ljava/io/InputStream;)Lcom/bumptech/glide/f/c;

    move-result-object v19

    .line 124
    new-instance v10, Lcom/bumptech/glide/f/g;

    move-object/from16 v0, v19

    invoke-direct {v10, v0}, Lcom/bumptech/glide/f/g;-><init>(Ljava/io/InputStream;)V
    ...
    invoke-virtual {v0, v2}, Lcom/bumptech/glide/f/c;->mark(I)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    .line 136
    :try_start_2
    invoke-virtual/range {v19 .. v19}, Lcom/bumptech/glide/f/c;->reset()V
    :try_end_2
    ...
    invoke-virtual {v0, v10, v8, v9}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)[I
    ...
    .line 150
    invoke-static {v15}, Lcom/bumptech/glide/load/resource/bitmap/l;->a(I)I
    ...
    .line 151
    invoke-direct/range {v2 .. v7}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(IIIII)I
    ...
    .line 153
    invoke-direct/range {v6 .. v14}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;IIILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;

    move-result-object v3

    .line 160
    invoke-virtual/range {v19 .. v19}, Lcom/bumptech/glide/f/c;->b()Ljava/io/IOException;
    ...
    invoke-virtual/range {v16 .. v17}, Lcom/bumptech/glide/f/a;->a([B)Z
    ...
    invoke-virtual {v0, v1}, Lcom/bumptech/glide/f/a;->a([B)Z

    .line 178
    invoke-virtual/range {v19 .. v19}, Lcom/bumptech/glide/f/c;->c()V

    .line 179
    invoke-static {v9}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Landroid/graphics/BitmapFactory$Options;)V
    ...
    invoke-static {v3, v0, v15}, Lcom/bumptech/glide/load/resource/bitmap/l;->a(Landroid/graphics/Bitmap;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;I)Landroid/graphics/Bitmap;
    ...
    invoke-interface {v0, v3}, Lcom/bumptech/glide/load/engine/bitmap_recycle/c;->a(Landroid/graphics/Bitmap;)Z
...
.method public bridge synthetic a(Ljava/lang/Object;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;IILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-virtual/range {v0 .. v5}, Lcom/bumptech/glide/load/resource/bitmap/e;->a(Ljava/io/InputStream;Lcom/bumptech/glide/load/engine/bitmap_recycle/c;IILcom/bumptech/glide/load/DecodeFormat;)Landroid/graphics/Bitmap;
...
.method public a(Lcom/bumptech/glide/f/g;Lcom/bumptech/glide/load/resource/bitmap/RecyclableBufferedInputStream;Landroid/graphics/BitmapFactory$Options;)[I
    .locals 4
