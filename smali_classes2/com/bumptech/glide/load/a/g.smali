...
# instance fields
.field private final d:Lcom/bumptech/glide/load/model/c;
...
.method public constructor <init>(Lcom/bumptech/glide/load/model/c;)V
    ...
    invoke-direct {p0, p1, v0}, Lcom/bumptech/glide/load/a/g;-><init>(Lcom/bumptech/glide/load/model/c;Lcom/bumptech/glide/load/a/g$b;)V

    .line 34
    return-void
.end method

.method constructor <init>(Lcom/bumptech/glide/load/model/c;Lcom/bumptech/glide/load/a/g$b;)V
    .locals 0
    ...
    .line 38
    iput-object p1, p0, Lcom/bumptech/glide/load/a/g;->d:Lcom/bumptech/glide/load/model/c;
...
.method private a(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/a/g;->g:Ljava/io/InputStream;
...
.method private a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    .line 62
    :cond_1
    iget-object v0, p0, Lcom/bumptech/glide/load/a/g;->e:Lcom/bumptech/glide/load/a/g$b;

    invoke-interface {v0, p1}, Lcom/bumptech/glide/load/a/g$b;->a(Ljava/net/URL;)Ljava/net/HttpURLConnection;

    move-result-object v0

    iput-object v0, p0, Lcom/bumptech/glide/load/a/g;->f:Ljava/net/HttpURLConnection;
    ...
    .line 64
    iget-object v3, p0, Lcom/bumptech/glide/load/a/g;->f:Ljava/net/HttpURLConnection;
    ...
    .line 73
    iget-boolean v0, p0, Lcom/bumptech/glide/load/a/g;->h:Z
    ...
    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/a/g;->a(Ljava/net/HttpURLConnection;)Ljava/io/InputStream;
    ...
    invoke-direct {p0, v1, v0, p1, p4}, Lcom/bumptech/glide/load/a/g;->a(Ljava/net/URL;ILjava/net/URL;Ljava/util/Map;)Ljava/io/InputStream;
    ...
    iget-object v2, p0, Lcom/bumptech/glide/load/a/g;->f:Ljava/net/HttpURLConnection;
...
.method public a(Lcom/bumptech/glide/Priority;)Ljava/io/InputStream;
    ...
    .prologue
    .line 44
    iget-object v0, p0, Lcom/bumptech/glide/load/a/g;->d:Lcom/bumptech/glide/load/model/c;

    invoke-virtual {v0}, Lcom/bumptech/glide/load/model/c;->a()Ljava/net/URL;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/a/g;->d:Lcom/bumptech/glide/load/model/c;

    invoke-virtual {v3}, Lcom/bumptech/glide/load/model/c;->c()Ljava/util/Map;
...
.method public synthetic b(Lcom/bumptech/glide/Priority;)Ljava/lang/Object;
    ...
    .prologue
    .line 20
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/a/g;->a(Lcom/bumptech/glide/Priority;)Ljava/io/InputStream;
