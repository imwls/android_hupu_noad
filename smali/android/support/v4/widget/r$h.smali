.class Landroid/support/v4/widget/r$h;
...
.method public a(Landroid/widget/TextView;)I
    ...
    .line 131
    sget-boolean v0, Landroid/support/v4/widget/r$h;->f:Z
    ...
    invoke-static {v0}, Landroid/support/v4/widget/r$h;->a(Ljava/lang/String;)Ljava/lang/reflect/Field;

    move-result-object v0

    sput-object v0, Landroid/support/v4/widget/r$h;->e:Ljava/lang/reflect/Field;

    .line 133
    sput-boolean v1, Landroid/support/v4/widget/r$h;->f:Z

    .line 135
    :cond_0
    sget-object v0, Landroid/support/v4/widget/r$h;->e:Ljava/lang/reflect/Field;

    if-eqz v0, :cond_2

    sget-object v0, Landroid/support/v4/widget/r$h;->e:Ljava/lang/reflect/Field;

    invoke-static {v0, p1}, Landroid/support/v4/widget/r$h;->a(Ljava/lang/reflect/Field;Landroid/widget/TextView;)I
    ...
    .line 137
    sget-boolean v0, Landroid/support/v4/widget/r$h;->d:Z
    ...
    sput-object v0, Landroid/support/v4/widget/r$h;->c:Ljava/lang/reflect/Field;

    .line 139
    sput-boolean v1, Landroid/support/v4/widget/r$h;->d:Z

    .line 141
    :cond_1
    sget-object v0, Landroid/support/v4/widget/r$h;->c:Ljava/lang/reflect/Field;
...
.method public b(Landroid/widget/TextView;)I
    ...
    .line 149
    sget-boolean v0, Landroid/support/v4/widget/r$h;->j:Z
    ...
    sput-object v0, Landroid/support/v4/widget/r$h;->i:Ljava/lang/reflect/Field;

    .line 151
    sput-boolean v1, Landroid/support/v4/widget/r$h;->j:Z

    .line 153
    :cond_0
    sget-object v0, Landroid/support/v4/widget/r$h;->i:Ljava/lang/reflect/Field;
    ...
    .line 155
    sget-boolean v0, Landroid/support/v4/widget/r$h;->h:Z
    ...
    sput-object v0, Landroid/support/v4/widget/r$h;->g:Ljava/lang/reflect/Field;

    .line 157
    sput-boolean v1, Landroid/support/v4/widget/r$h;->h:Z

    .line 159
    :cond_1
    sget-object v0, Landroid/support/v4/widget/r$h;->g:Ljava/lang/reflect/Field;
