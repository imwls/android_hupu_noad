...
.field private p:Landroid/support/v4/widget/q$a;

.field private q:Landroid/support/v4/widget/q$b;
...
.method public constructor <init>(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[I)V
    ...
    .prologue
    .line 68
    invoke-direct {p0, p1, p2, p3}, Landroid/support/v4/widget/o;-><init>(Landroid/content/Context;ILandroid/database/Cursor;)V
    ...
    .line 71
    invoke-direct {p0, p3, p4}, Landroid/support/v4/widget/q;->a(Landroid/database/Cursor;[Ljava/lang/String;)V
...
.method public constructor <init>(Landroid/content/Context;ILandroid/database/Cursor;[Ljava/lang/String;[II)V
    ...
    .prologue
    .line 94
    invoke-direct {p0, p1, p2, p3, p6}, Landroid/support/v4/widget/o;-><init>(Landroid/content/Context;ILandroid/database/Cursor;I)V
...
.method public a(Landroid/database/Cursor;[Ljava/lang/String;[I)V
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v4/widget/q;->a(Landroid/database/Cursor;[Ljava/lang/String;)V
...
.method public a(Landroid/support/v4/widget/q$a;)V
    .locals 0

    .prologue
    .line 282
    iput-object p1, p0, Landroid/support/v4/widget/q;->p:Landroid/support/v4/widget/q$a;

    .line 283
    return-void
.end method

.method public a(Landroid/support/v4/widget/q$b;)V
    .locals 0

    .prologue
    .line 179
    iput-object p1, p0, Landroid/support/v4/widget/q;->q:Landroid/support/v4/widget/q$b;
...
.method public a(Landroid/view/View;Landroid/content/Context;Landroid/database/Cursor;)V
    ...
    .line 125
    iget-object v4, p0, Landroid/support/v4/widget/q;->q:Landroid/support/v4/widget/q$b;
    ...
    invoke-interface {v4, v0, p3, v1}, Landroid/support/v4/widget/q$b;->a(Landroid/view/View;Landroid/database/Cursor;I)Z
...
.method public c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    .prologue
    .line 298
    iget-object v0, p0, Landroid/support/v4/widget/q;->p:Landroid/support/v4/widget/q$a;
    ...
    invoke-interface {v0, p1}, Landroid/support/v4/widget/q$a;->a(Landroid/database/Cursor;)Ljava/lang/CharSequence;
    ...
    .line 304
    :cond_1
    invoke-super {p0, p1}, Landroid/support/v4/widget/o;->c(Landroid/database/Cursor;)Ljava/lang/CharSequence;
...
.method public d()Landroid/support/v4/widget/q$b;
    .locals 1

    .prologue
    .line 166
    iget-object v0, p0, Landroid/support/v4/widget/q;->q:Landroid/support/v4/widget/q$b;
...
.method public f()Landroid/support/v4/widget/q$a;
    .locals 1
