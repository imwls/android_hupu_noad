...
.method public constructor <init>(Landroid/support/v4/app/h;)V
    ...
    .line 47
    iget-object v1, p1, Landroid/support/v4/app/h;->m:Ljava/util/ArrayList;
    ...
    .line 50
    iget-boolean v1, p1, Landroid/support/v4/app/h;->t:Z
    ...
    .line 56
    iget-object v0, p1, Landroid/support/v4/app/h;->m:Ljava/util/ArrayList;
    ...
    .line 64
    :cond_2
    iget v0, p1, Landroid/support/v4/app/h;->r:I
    ...
    .line 66
    iget-object v0, p1, Landroid/support/v4/app/h;->v:Ljava/lang/String;
    ...
    .line 69
    iget-object v0, p1, Landroid/support/v4/app/h;->z:Ljava/lang/CharSequence;

    iput-object v0, p0, Landroid/support/v4/app/BackStackState;->g:Ljava/lang/CharSequence;

    .line 70
    iget v0, p1, Landroid/support/v4/app/h;->A:I

    iput v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    .line 71
    iget-object v0, p1, Landroid/support/v4/app/h;->B:Ljava/lang/CharSequence;
...
# virtual methods
.method public a(Landroid/support/v4/app/p;)Landroid/support/v4/app/h;
    .locals 8
    ...
    invoke-direct {v3, p1}, Landroid/support/v4/app/h;-><init>(Landroid/support/v4/app/p;)V
    ...
    iput-object v0, v3, Landroid/support/v4/app/h;->v:Ljava/lang/String;

    .line 122
    iget v0, p0, Landroid/support/v4/app/BackStackState;->e:I

    iput v0, v3, Landroid/support/v4/app/h;->x:I

    .line 123
    iput-boolean v7, v3, Landroid/support/v4/app/h;->t:Z
    ...
    iput-object v0, v3, Landroid/support/v4/app/h;->z:Ljava/lang/CharSequence;

    .line 126
    iget v0, p0, Landroid/support/v4/app/BackStackState;->h:I

    iput v0, v3, Landroid/support/v4/app/h;->A:I

    .line 127
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->i:Ljava/lang/CharSequence;

    iput-object v0, v3, Landroid/support/v4/app/h;->B:Ljava/lang/CharSequence;

    .line 128
    iget-object v0, p0, Landroid/support/v4/app/BackStackState;->j:Ljava/util/ArrayList;

    iput-object v0, v3, Landroid/support/v4/app/h;->C:Ljava/util/ArrayList;
    ...
    iput-boolean v0, v3, Landroid/support/v4/app/h;->E:Z
