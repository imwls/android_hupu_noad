...
.field private static j:Landroid/support/v4/content/d;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v4/content/d;->i:Ljava/lang/Object;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->f:Ljava/util/HashMap;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->g:Ljava/util/ArrayList;

    .line 113
    iput-object p1, p0, Landroid/support/v4/content/d;->d:Landroid/content/Context;
    ...
    iput-object v0, p0, Landroid/support/v4/content/d;->h:Landroid/os/Handler;
...
.method public static a(Landroid/content/Context;)Landroid/support/v4/content/d;
    ...
    .prologue
    .line 104
    sget-object v1, Landroid/support/v4/content/d;->i:Ljava/lang/Object;

    monitor-enter v1

    .line 105
    :try_start_0
    sget-object v0, Landroid/support/v4/content/d;->j:Landroid/support/v4/content/d;
    ...
    sput-object v0, Landroid/support/v4/content/d;->j:Landroid/support/v4/content/d;
...
.method private a()V
    ...
    .line 296
    :cond_0
    iget-object v1, p0, Landroid/support/v4/content/d;->e:Ljava/util/HashMap;

    monitor-enter v1

    .line 297
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/content/d;->g:Ljava/util/ArrayList;
    ...
    iget-object v7, p0, Landroid/support/v4/content/d;->d:Landroid/content/Context;
...
.method public a(Landroid/content/BroadcastReceiver;)V
    ...
    .line 170
    :try_start_0
    iget-object v0, p0, Landroid/support/v4/content/d;->e:Ljava/util/HashMap;
    ...
    .line 179
    iget-object v2, p0, Landroid/support/v4/content/d;->f:Ljava/util/HashMap;
...
.method public a(Landroid/content/BroadcastReceiver;Landroid/content/IntentFilter;)V
    ...
    .prologue
    .line 139
    iget-object v2, p0, Landroid/support/v4/content/d;->e:Ljava/util/HashMap;
    ...
    .line 149
    iget-object v0, p0, Landroid/support/v4/content/d;->f:Ljava/util/HashMap;
    ...
    .line 152
    iget-object v5, p0, Landroid/support/v4/content/d;->f:Ljava/util/HashMap;
...
.method public a(Landroid/content/Intent;)Z
    ...
    iget-object v13, v0, Landroid/support/v4/content/d;->e:Ljava/util/HashMap;
    ...
    iget-object v1, v0, Landroid/support/v4/content/d;->d:Landroid/content/Context;
    ...
    iget-object v1, v0, Landroid/support/v4/content/d;->f:Ljava/util/HashMap;
    ...
    iget-object v1, v0, Landroid/support/v4/content/d;->g:Ljava/util/ArrayList;
    ...
    iget-object v1, v0, Landroid/support/v4/content/d;->h:Landroid/os/Handler;
