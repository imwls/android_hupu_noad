...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/transition/ac;->a:[Ljava/lang/Class;
    ...
    sput-object v0, Landroid/support/transition/ac;->b:Landroid/support/v4/j/a;
...
.method private constructor <init>(Landroid/content/Context;)V
    ...
    .line 49
    iput-object p1, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;
...
.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    ...
    iget-object v0, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;
    ...
    .line 177
    invoke-direct {p0, p1, p2, v0}, Landroid/support/transition/ac;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    ...
    invoke-direct {p0, p2, v0, v3}, Landroid/support/transition/ac;->a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    .line 155
    invoke-direct {p0, p1, p2, p3}, Landroid/support/transition/ac;->b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
    ...
    iget-object v5, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;

    invoke-direct {v0, v5, p2}, Landroid/support/transition/ArcMotion;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    invoke-virtual {p3, v0}, Landroid/support/transition/Transition;->a(Landroid/support/transition/PathMotion;)V
    ...
    invoke-direct {p0, p2, v0, v5}, Landroid/support/transition/ac;->a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
...
.method public static a(Landroid/content/Context;)Landroid/support/transition/ac;
    .locals 1
    ...
    invoke-direct {v0, p0}, Landroid/support/transition/ac;-><init>(Landroid/content/Context;)V

    return-object v0
.end method

.method private a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/ae;
    .locals 4
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Lorg/xmlpull/v1/XmlPullParserException;,
    ...
    .line 298
    invoke-direct {p0, p2, p1, p3, v0}, Landroid/support/transition/ac;->a(Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;Landroid/support/transition/ae;)V
...
.method private a(Landroid/util/AttributeSet;Ljava/lang/Class;Ljava/lang/String;)Ljava/lang/Object;
    ...
    :cond_0
    :try_start_0
    sget-object v2, Landroid/support/transition/ac;->b:Landroid/support/v4/j/a;
    ...
    .line 200
    :try_start_1
    sget-object v0, Landroid/support/transition/ac;->b:Landroid/support/v4/j/a;
    ...
    .line 203
    iget-object v3, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;
    ...
    .line 206
    sget-object v0, Landroid/support/transition/ac;->a:[Ljava/lang/Class;
    ...
    .line 208
    sget-object v3, Landroid/support/transition/ac;->b:Landroid/support/v4/j/a;

    invoke-virtual {v3, v1, v0}, Landroid/support/v4/j/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
...
.method private a(Landroid/util/AttributeSet;Lorg/xmlpull/v1/XmlPullParser;Landroid/view/ViewGroup;Landroid/support/transition/ae;)V
    .locals 7
    .annotation system Ldalvik/annotation/Throws;
        value = {
    ...
    sget-object v2, Landroid/support/transition/ab;->b:[I
    ...
    .line 321
    invoke-virtual {p0, v3}, Landroid/support/transition/ac;->a(I)Landroid/support/transition/Transition;
    ...
    .line 314
    :cond_0
    iget-object v4, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;

    invoke-static {p3, v0, v4}, Landroid/support/transition/z;->a(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroid/support/transition/z;
    ...
    .line 318
    :cond_1
    iget-object v1, p0, Landroid/support/transition/ac;->c:Landroid/content/Context;

    invoke-static {p3, v4, v1}, Landroid/support/transition/z;->a(Landroid/view/ViewGroup;ILandroid/content/Context;)Landroid/support/transition/z;
    ...
    .line 327
    invoke-virtual {p4, v1, v4}, Landroid/support/transition/ae;->a(Landroid/support/transition/z;Landroid/support/transition/Transition;)V
    ...
    .line 329
    :cond_4
    invoke-virtual {p4, v0, v1, v4}, Landroid/support/transition/ae;->a(Landroid/support/transition/z;Landroid/support/transition/z;Landroid/support/transition/Transition;)V
...
.method private b(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)V
    ...
    sget-object v2, Landroid/support/transition/ab;->a:[I
    ...
    .line 241
    invoke-virtual {p3, v1}, Landroid/support/transition/Transition;->b(I)Landroid/support/transition/Transition;
    ...
    .line 244
    invoke-virtual {p3, v1, v5}, Landroid/support/transition/Transition;->a(IZ)Landroid/support/transition/Transition;
    ...
    .line 247
    invoke-virtual {p3, v1}, Landroid/support/transition/Transition;->a(Ljava/lang/String;)Landroid/support/transition/Transition;
    ...
    .line 250
    invoke-virtual {p3, v1, v5}, Landroid/support/transition/Transition;->a(Ljava/lang/String;Z)Landroid/support/transition/Transition;
    ...
    invoke-virtual {p3, v3, v4}, Landroid/support/transition/Transition;->a(Ljava/lang/Class;Z)Landroid/support/transition/Transition;
    :try_end_0
    ...
    .line 261
    invoke-virtual {p3, v3}, Landroid/support/transition/Transition;->a(Ljava/lang/Class;)Landroid/support/transition/Transition;
    :try_end_1
...
.method public a(I)Landroid/support/transition/Transition;
    ...
    invoke-direct {p0, v1, v0, v2}, Landroid/support/transition/ac;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/support/transition/Transition;)Landroid/support/transition/Transition;
    :try_end_0
...
.method public a(ILandroid/view/ViewGroup;)Landroid/support/transition/ae;
    .locals 5
    ...
    invoke-direct {p0, v1, v0, p2}, Landroid/support/transition/ac;->a(Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/view/ViewGroup;)Landroid/support/transition/ae;
    :try_end_0
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_0 .. :try_end_0} :catch_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_1
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
