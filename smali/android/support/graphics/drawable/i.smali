...
# instance fields
.field private p:Landroid/support/graphics/drawable/i$f;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/graphics/drawable/i;->b:Landroid/graphics/PorterDuff$Mode;
...
.method constructor <init>()V
    ...
    iput-boolean v0, p0, Landroid/support/graphics/drawable/i;->t:Z
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i;->v:[F
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i;->w:Landroid/graphics/Matrix;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;
...
.method constructor <init>(Landroid/support/graphics/drawable/i$f;)V
    .locals 3
    .param p1    # Landroid/support/graphics/drawable/i$f;
    ...
    .line 248
    iput-object p1, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;

    .line 249
    iget-object v0, p0, Landroid/support/graphics/drawable/i;->q:Landroid/graphics/PorterDuffColorFilter;

    iget-object v1, p1, Landroid/support/graphics/drawable/i$f;->c:Landroid/content/res/ColorStateList;

    iget-object v2, p1, Landroid/support/graphics/drawable/i$f;->d:Landroid/graphics/PorterDuff$Mode;
    ...
    iput-object v0, p0, Landroid/support/graphics/drawable/i;->q:Landroid/graphics/PorterDuffColorFilter;
...
.method public static a(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/support/graphics/drawable/i;
    ...
    invoke-direct {v1, v2}, Landroid/support/graphics/drawable/i$g;-><init>(Landroid/graphics/drawable/Drawable$ConstantState;)V

    iput-object v1, v0, Landroid/support/graphics/drawable/i;->u:Landroid/graphics/drawable/Drawable$ConstantState;
...
.method private a(Landroid/content/res/TypedArray;Lorg/xmlpull/v1/XmlPullParser;)V
    ...
    .line 662
    iget-object v0, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;
    ...
    iget-boolean v4, v0, Landroid/support/graphics/drawable/i$f;->e:Z
    ...
    iget v3, v1, Landroid/support/graphics/drawable/i$e;->d:F
    ...
    iget v3, v1, Landroid/support/graphics/drawable/i$e;->e:F
    ...
    iget v2, v1, Landroid/support/graphics/drawable/i$e;->b:F
    ...
    iget v2, v1, Landroid/support/graphics/drawable/i$e;->c:F
    ...
    .line 712
    invoke-virtual {v1, v0}, Landroid/support/graphics/drawable/i$e;->setAlpha(F)V
    ...
    .line 716
    iput-object v0, v1, Landroid/support/graphics/drawable/i$e;->g:Ljava/lang/String;

    .line 717
    iget-object v2, v1, Landroid/support/graphics/drawable/i$e;->h:Landroid/support/v4/j/a;
...
.method private a(Landroid/support/graphics/drawable/i$c;I)V
    .locals 5
    ...
    invoke-virtual {p1}, Landroid/support/graphics/drawable/i$c;->getGroupName()Ljava/lang/String;
    ...
    iget v4, p1, Landroid/support/graphics/drawable/i$c;->b:F
    ...
    invoke-virtual {p1}, Landroid/support/graphics/drawable/i$c;->getLocalMatrix()Landroid/graphics/Matrix;
    ...
    invoke-direct {p0, v0, v2}, Landroid/support/graphics/drawable/i;->a(Landroid/support/graphics/drawable/i$c;I)V
    ...
    invoke-virtual {v0, v2}, Landroid/support/graphics/drawable/i$d;->a(I)V
...
.method private b(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    .line 723
    iget-object v3, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;

    .line 724
    iget-object v4, v3, Landroid/support/graphics/drawable/i$f;->b:Landroid/support/graphics/drawable/i$e;
    ...
    .line 730
    iget-object v0, v4, Landroid/support/graphics/drawable/i$e;->a:Landroid/support/graphics/drawable/i$c;
    ...
    .line 744
    iget-object v0, v0, Landroid/support/graphics/drawable/i$c;->a:Ljava/util/ArrayList;
    ...
    .line 746
    iget-object v0, v4, Landroid/support/graphics/drawable/i$e;->h:Landroid/support/v4/j/a;

    invoke-virtual {v1}, Landroid/support/graphics/drawable/i$b;->getPathName()Ljava/lang/String;

    move-result-object v7

    invoke-virtual {v0, v7, v1}, Landroid/support/v4/j/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 749
    iget v7, v3, Landroid/support/graphics/drawable/i$f;->a:I

    iget v1, v1, Landroid/support/graphics/drawable/i$b;->o:I

    or-int/2addr v1, v7

    iput v1, v3, Landroid/support/graphics/drawable/i$f;->a:I
    ...
    invoke-virtual {v0, v8, v7}, Landroid/support/v4/j/a;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 757
    :cond_4
    iget v0, v3, Landroid/support/graphics/drawable/i$f;->a:I

    iget v7, v7, Landroid/support/graphics/drawable/i$a;->o:I

    or-int/2addr v0, v7

    iput v0, v3, Landroid/support/graphics/drawable/i$f;->a:I
    ...
    iget v7, v7, Landroid/support/graphics/drawable/i$c;->c:I
...
.method public a()F
    ...
    iget v0, v0, Landroid/support/graphics/drawable/i$e;->e:F
    ...
    iget v0, v0, Landroid/support/graphics/drawable/i$e;->d:F
    ...
    .line 534
    iget-object v1, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;

    iget-object v1, v1, Landroid/support/graphics/drawable/i$f;->b:Landroid/support/graphics/drawable/i$e;

    iget v1, v1, Landroid/support/graphics/drawable/i$e;->c:F

    .line 535
    iget-object v2, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;

    iget-object v2, v2, Landroid/support/graphics/drawable/i$f;->b:Landroid/support/graphics/drawable/i$e;

    iget v2, v2, Landroid/support/graphics/drawable/i$e;->d:F

    .line 536
    iget-object v3, p0, Landroid/support/graphics/drawable/i;->p:Landroid/support/graphics/drawable/i$f;

    iget-object v3, v3, Landroid/support/graphics/drawable/i$f;->b:Landroid/support/graphics/drawable/i$e;

    iget v3, v3, Landroid/support/graphics/drawable/i$e;->e:F
...
.method a(Ljava/lang/String;)Ljava/lang/Object;
    ...
    iget-object v0, v0, Landroid/support/graphics/drawable/i$e;->h:Landroid/support/v4/j/a;
...
.method a(Z)V
    ...
    .prologue
    .line 809
    iput-boolean p1, p0, Landroid/support/graphics/drawable/i;->t:Z
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    .line 288
    :cond_1
    iget-object v0, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;
    ...
    .line 295
    iget-object v0, p0, Landroid/support/graphics/drawable/i;->r:Landroid/graphics/ColorFilter;
    ...
    .line 301
    :goto_1
    iget-object v1, p0, Landroid/support/graphics/drawable/i;->w:Landroid/graphics/Matrix;
    ...
    iget-object v3, p0, Landroid/support/graphics/drawable/i;->v:[F

    invoke-virtual {v1, v3}, Landroid/graphics/Matrix;->getValues([F)V

    .line 303
    iget-object v1, p0, Landroid/support/graphics/drawable/i;->v:[F
    ...
    .line 306
    iget-object v4, p0, Landroid/support/graphics/drawable/i;->v:[F
    ...
    .line 307
    iget-object v5, p0, Landroid/support/graphics/drawable/i;->v:[F
    ...
    .line 315
    :cond_3
    iget-object v4, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;
    ...
    .line 325
    iget-object v5, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;

    iget v5, v5, Landroid/graphics/Rect;->left:I

    int-to-float v5, v5

    iget-object v6, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;
    ...
    .line 328
    invoke-direct {p0}, Landroid/support/graphics/drawable/i;->b()Z
    ...
    .line 337
    :cond_4
    iget-object v2, p0, Landroid/support/graphics/drawable/i;->x:Landroid/graphics/Rect;
    ...
    invoke-virtual {v2, v3, v1}, Landroid/support/graphics/drawable/i$f;->b(II)V

    .line 340
    iget-boolean v2, p0, Landroid/support/graphics/drawable/i;->t:Z
    ...
    invoke-virtual {v2, v3, v1}, Landroid/support/graphics/drawable/i$f;->a(II)V
...
.method public inflate(Landroid/content/res/Resources;Lorg/xmlpull/v1/XmlPullParser;Landroid/util/AttributeSet;Landroid/content/res/Resources$Theme;)V
    ...
    iput-boolean v1, v0, Landroid/support/graphics/drawable/i$f;->l:Z
    ...
    .line 633
    iget-object v1, p0, Landroid/support/graphics/drawable/i;->q:Landroid/graphics/PorterDuffColorFilter;

    iget-object v2, v0, Landroid/support/graphics/drawable/i$f;->c:Landroid/content/res/ColorStateList;
...
.method public mutate()Landroid/graphics/drawable/Drawable;
    ...
    .line 259
    :cond_1
    iget-boolean v0, p0, Landroid/support/graphics/drawable/i;->s:Z
    ...
    iput-boolean v0, p0, Landroid/support/graphics/drawable/i;->s:Z
...
.method public setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    .line 381
    :cond_0
    iput-object p1, p0, Landroid/support/graphics/drawable/i;->r:Landroid/graphics/ColorFilter;
