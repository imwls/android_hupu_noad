...
.method public constructor <init>(Landroid/content/Context;Z)V
    ...
    .line 143
    iput v3, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->c:I

    .line 144
    iput v4, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->d:I
    ...
    .line 146
    :cond_0
    iput v4, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->c:I

    .line 147
    iput v3, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->d:I
...
.method public bridge synthetic a(IZ)I
    ...
    .prologue
    .line 128
    invoke-super {p0, p1, p2}, Landroid/support/v7/widget/DropDownListView;->a(IZ)I
...
.method public onHoverEvent(Landroid/view/MotionEvent;)Z
    ...
    .prologue
    .line 183
    iget-object v0, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->e:Landroid/support/v7/widget/af;
    ...
    .line 209
    :goto_1
    iget-object v2, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->f:Landroid/view/MenuItem;

    .line 210
    if-eq v2, v1, :cond_1

    .line 211
    invoke-virtual {v0}, Landroid/support/v7/view/menu/g;->b()Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 213
    iget-object v3, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->e:Landroid/support/v7/widget/af;

    invoke-interface {v3, v0, v2}, Landroid/support/v7/widget/af;->a(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)V

    .line 216
    :cond_0
    iput-object v1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->f:Landroid/view/MenuItem;

    .line 218
    if-eqz v1, :cond_1

    .line 219
    iget-object v2, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->e:Landroid/support/v7/widget/af;

    invoke-interface {v2, v0, v1}, Landroid/support/v7/widget/af;->b(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/MenuItem;)V
...
.method public onKeyDown(ILandroid/view/KeyEvent;)Z
    ...
    iget v2, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->c:I
    ...
    iget v0, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->d:I
...
.method public setHoverListener(Landroid/support/v7/widget/af;)V
    ...
    .prologue
    .line 152
    iput-object p1, p0, Landroid/support/v7/widget/MenuPopupWindow$MenuDropDownListView;->e:Landroid/support/v7/widget/af;
