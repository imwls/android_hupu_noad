...
.method private a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    ...
    .line 281
    :cond_0
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->v:Landroid/support/v7/widget/RecyclerView$o;
...
.method private a()V
    ...
    .line 219
    iget-object v4, v0, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    invoke-virtual {v4, v0, v3}, Landroid/support/v7/widget/ac$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 220
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    iget v0, v0, Landroid/support/v7/widget/ac$a;->d:I
    ...
    .line 234
    :cond_1
    iget-object v8, v0, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    .line 235
    iget v2, v8, Landroid/support/v7/widget/ac$a;->a:I

    invoke-static {v2}, Ljava/lang/Math;->abs(I)I

    move-result v2

    iget v4, v8, Landroid/support/v7/widget/ac$a;->b:I
    ...
    .line 237
    :goto_4
    iget v1, v8, Landroid/support/v7/widget/ac$a;->d:I
    ...
    .line 240
    new-instance v1, Landroid/support/v7/widget/ac$b;

    invoke-direct {v1}, Landroid/support/v7/widget/ac$b;-><init>()V

    .line 241
    iget-object v5, p0, Landroid/support/v7/widget/ac;->f:Ljava/util/ArrayList;

    invoke-virtual {v5, v1}, Ljava/util/ArrayList;->add(Ljava/lang/Object;)Z

    .line 245
    :goto_5
    iget-object v5, v8, Landroid/support/v7/widget/ac$a;->c:[I
    ...
    :goto_6
    iput-boolean v5, v1, Landroid/support/v7/widget/ac$b;->a:Z

    .line 248
    iput v9, v1, Landroid/support/v7/widget/ac$b;->b:I

    .line 249
    iput v10, v1, Landroid/support/v7/widget/ac$b;->c:I

    .line 250
    iput-object v0, v1, Landroid/support/v7/widget/ac$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    iput v5, v1, Landroid/support/v7/widget/ac$b;->e:I
...
.method private a(Landroid/support/v7/widget/RecyclerView;J)V
    ...
    .line 321
    :cond_2
    iget-object v1, p1, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    .line 322
    const/4 v0, 0x1

    invoke-virtual {v1, p1, v0}, Landroid/support/v7/widget/ac$a;->a(Landroid/support/v7/widget/RecyclerView;Z)V

    .line 324
    iget v0, v1, Landroid/support/v7/widget/ac$a;->d:I
    ...
    .line 327
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->ab:Landroid/support/v7/widget/RecyclerView$t;

    iget-object v2, p1, Landroid/support/v7/widget/RecyclerView;->D:Landroid/support/v7/widget/RecyclerView$a;
    ...
    :goto_1
    iget v2, v1, Landroid/support/v7/widget/ac$a;->d:I
    ...
    .line 331
    iget-object v2, v1, Landroid/support/v7/widget/ac$a;->c:[I

    aget v2, v2, v0

    .line 332
    invoke-direct {p0, p1, v2, p2, p3}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method private a(Landroid/support/v7/widget/ac$b;J)V
    ...
    iget v3, p1, Landroid/support/v7/widget/ac$b;->e:I

    invoke-direct {p0, v2, v3, v0, v1}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/RecyclerView;IJ)Landroid/support/v7/widget/RecyclerView$w;
    ...
    .line 348
    iget-object v0, v0, Landroid/support/v7/widget/RecyclerView$w;->mNestedRecyclerView:Ljava/lang/ref/WeakReference;
    ...
    invoke-direct {p0, v0, p2, p3}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/RecyclerView;J)V
...
.method static a(Landroid/support/v7/widget/RecyclerView;I)Z
    ...
    invoke-virtual {v3, v1}, Landroid/support/v7/widget/t;->d(I)Landroid/view/View;
...
.method private b(J)V
    ...
    .line 355
    iget-object v2, v0, Landroid/support/v7/widget/ac$b;->d:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 358
    :cond_1
    invoke-direct {p0, v0, p1, p2}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/ac$b;J)V

    .line 359
    invoke-virtual {v0}, Landroid/support/v7/widget/ac$b;->a()V
...
.method a(Landroid/support/v7/widget/RecyclerView;II)V
    ...
    .line 184
    :cond_0
    iget-object v0, p1, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    invoke-virtual {v0, p2, p3}, Landroid/support/v7/widget/ac$a;->a(II)V
...
.method public run()V
    ...
    .line 400
    iput-wide v6, p0, Landroid/support/v7/widget/ac;->c:J
    ...
    iget-wide v2, p0, Landroid/support/v7/widget/ac;->d:J

    add-long/2addr v0, v2

    .line 396
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/ac;->a(J)V
    :try_end_2
