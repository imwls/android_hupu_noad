...
.method public static a(Landroid/content/Context;I[I)Landroid/support/v7/widget/ay;
    .locals 2
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/ay;-><init>(Landroid/content/Context;Landroid/content/res/TypedArray;)V

    return-object v0
.end method

.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[I)Landroid/support/v7/widget/ay;
    .locals 2
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ay;
    .locals 2
...
.method public a(IILandroid/support/v4/content/b/c$a;)Landroid/graphics/Typeface;
    .locals 3
    .param p1    # I
        .annotation build Landroid/support/annotation/ar;
        .end annotation
    .end param
    .param p3    # Landroid/support/v4/content/b/c$a;
    ...
    iput-object v1, p0, Landroid/support/v7/widget/ay;->c:Landroid/util/TypedValue;

    .line 118
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/ay;->a:Landroid/content/Context;

    iget-object v2, p0, Landroid/support/v7/widget/ay;->c:Landroid/util/TypedValue;

    invoke-static {v1, v0, v2, p2, p3}, Landroid/support/v4/content/b/c;->a(Landroid/content/Context;ILandroid/util/TypedValue;ILandroid/support/v4/content/b/c$a;)Landroid/graphics/Typeface;
...
.method public b(I)Landroid/graphics/drawable/Drawable;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ay;->a:Landroid/content/Context;
