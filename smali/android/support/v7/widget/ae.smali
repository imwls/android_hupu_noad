...
.method private a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;II)I
    .locals 6
    ...
    .line 167
    invoke-direct {p0, p1, p2}, Landroid/support/v7/widget/ae;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;)F
...
.method private a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;Landroid/support/v7/widget/ah;)I
    .locals 3
    ...
    .line 146
    invoke-virtual {p3}, Landroid/support/v7/widget/ah;->d()I

    move-result v0

    invoke-virtual {p3}, Landroid/support/v7/widget/ah;->g()I
...
.method private b(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;)F
    .locals 10
...
.method private d(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/ah;
    .locals 1
    .param p1    # Landroid/support/v7/widget/RecyclerView$LayoutManager;
        .annotation build Landroid/support/annotation/ag;
        .end annotation
    ...
    iget-object v0, v0, Landroid/support/v7/widget/ah;->a:Landroid/support/v7/widget/RecyclerView$LayoutManager;
...
.method private e(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/ah;
    .locals 1
    .param p1    # Landroid/support/v7/widget/RecyclerView$LayoutManager;
        .annotation build Landroid/support/annotation/ag;
        .end annotation
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 74
    :cond_2
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    .line 98
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ae;->e(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/ah;

    move-result-object v0

    .line 97
    invoke-direct {p0, p1, v0, p2, v1}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;II)I
    ...
    .line 107
    invoke-direct {p0, p1}, Landroid/support/v7/widget/ae;->d(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/ah;

    move-result-object v2

    .line 106
    invoke-direct {p0, p1, v2, v1, p3}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;II)I
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    invoke-direct {p0, p1, v0}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/support/v7/widget/ah;)Landroid/view/View;
...
.method public a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 47
    invoke-direct {p0, p1, p2, v1}, Landroid/support/v7/widget/ae;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;Landroid/support/v7/widget/ah;)I
