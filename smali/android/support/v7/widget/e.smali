...
.method private b(Landroid/graphics/drawable/Drawable;)Z
    ...
    .line 172
    iget-object v1, p0, Landroid/support/v7/widget/e;->f:Landroid/support/v7/widget/aw;
    ...
    invoke-direct {v1}, Landroid/support/v7/widget/aw;-><init>()V

    iput-object v1, p0, Landroid/support/v7/widget/e;->f:Landroid/support/v7/widget/aw;
    ...
    invoke-static {v2}, Landroid/support/v4/view/x;->V(Landroid/view/View;)Landroid/content/res/ColorStateList;
    ...
    .line 180
    iput-boolean v0, v1, Landroid/support/v7/widget/aw;->d:Z

    .line 181
    iput-object v2, v1, Landroid/support/v7/widget/aw;->a:Landroid/content/res/ColorStateList;

    .line 183
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/e;->a:Landroid/view/View;

    invoke-static {v2}, Landroid/support/v4/view/x;->W(Landroid/view/View;)Landroid/graphics/PorterDuff$Mode;
    ...
    .line 185
    iput-boolean v0, v1, Landroid/support/v7/widget/aw;->c:Z

    .line 186
    iput-object v2, v1, Landroid/support/v7/widget/aw;->b:Landroid/graphics/PorterDuff$Mode;

    .line 189
    :cond_2
    iget-boolean v2, v1, Landroid/support/v7/widget/aw;->d:Z

    if-nez v2, :cond_3

    iget-boolean v2, v1, Landroid/support/v7/widget/aw;->c:Z
    ...
    invoke-static {p1, v1, v2}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/aw;[I)V
...
.method private d()Z
    ...
    .line 154
    iget-object v2, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/aw;
...
.method a()Landroid/content/res/ColorStateList;
    ...
    .prologue
    .line 99
    iget-object v0, p0, Landroid/support/v7/widget/e;->e:Landroid/support/v7/widget/aw;
...
.method a(Landroid/content/res/ColorStateList;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/e;->e:Landroid/support/v7/widget/aw;
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/aw;->d:Z
...
.method a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iput-boolean v1, v0, Landroid/support/v7/widget/aw;->c:Z
...
.method a(Landroid/util/AttributeSet;I)V
    ...
    invoke-static {v0, p1, v1, p2, v2}, Landroid/support/v7/widget/ay;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ay;
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/widget/ay;->g(II)I
    ...
    .line 60
    invoke-virtual {v1, v2}, Landroid/support/v7/widget/ay;->g(I)Landroid/content/res/ColorStateList;
    ...
    .line 65
    invoke-virtual {v1, v2, v3}, Landroid/support/v7/widget/ay;->a(II)I
    ...
    .line 64
    invoke-static {v2, v3}, Landroid/support/v7/widget/y;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
...
.method b(Landroid/content/res/ColorStateList;)V
    ...
    .line 138
    iget-object v0, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/aw;
    ...
    iput-object v0, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/aw;
...
.method c()V
    ...
    .line 126
    :cond_1
    iget-object v1, p0, Landroid/support/v7/widget/e;->e:Landroid/support/v7/widget/aw;
    ...
    .line 127
    invoke-static {v0, v1, v2}, Landroid/support/v7/widget/g;->a(Landroid/graphics/drawable/Drawable;Landroid/support/v7/widget/aw;[I)V

    goto :goto_0

    .line 129
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/e;->d:Landroid/support/v7/widget/aw;
