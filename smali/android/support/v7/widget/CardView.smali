...
.field private static final f:Landroid/support/v7/widget/s;
...
.field private final i:Landroid/support/v7/widget/r;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/s;

    .line 90
    :goto_0
    sget-object v0, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/s;

    invoke-interface {v0}, Landroid/support/v7/widget/s;->a()V
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/r;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/r;

    move-object v2, p1

    invoke-interface/range {v0 .. v6}, Landroid/support/v7/widget/s;->a(Landroid/support/v7/widget/r;Landroid/content/Context;Landroid/content/res/ColorStateList;FFF)V
...
.method public a(IIII)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->f(Landroid/support/v7/widget/r;)V
...
.method public getCardBackgroundColor()Landroid/content/res/ColorStateList;
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->i(Landroid/support/v7/widget/r;)Landroid/content/res/ColorStateList;
...
.method public getCardElevation()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->e(Landroid/support/v7/widget/r;)F
...
.method public getMaxCardElevation()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->a(Landroid/support/v7/widget/r;)F
...
.method public getRadius()F
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->d(Landroid/support/v7/widget/r;)F
...
.method protected onMeasure(II)V
    ...
    .line 235
    :sswitch_0
    sget-object v1, Landroid/support/v7/widget/CardView;->f:Landroid/support/v7/widget/s;

    iget-object v2, p0, Landroid/support/v7/widget/CardView;->i:Landroid/support/v7/widget/r;

    invoke-interface {v1, v2}, Landroid/support/v7/widget/s;->b(Landroid/support/v7/widget/r;)F
    ...
    invoke-interface {v1, v2}, Landroid/support/v7/widget/s;->c(Landroid/support/v7/widget/r;)F
...
.method public setCardBackgroundColor(I)V
    ...
    invoke-interface {v0, v1, v2}, Landroid/support/v7/widget/s;->a(Landroid/support/v7/widget/r;Landroid/content/res/ColorStateList;)V
...
.method public setCardBackgroundColor(Landroid/content/res/ColorStateList;)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/s;->a(Landroid/support/v7/widget/r;Landroid/content/res/ColorStateList;)V
...
.method public setCardElevation(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/s;->c(Landroid/support/v7/widget/r;F)V
...
.method public setMaxCardElevation(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/s;->b(Landroid/support/v7/widget/r;F)V
...
.method public setPreventCornerOverlap(Z)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->h(Landroid/support/v7/widget/r;)V
...
.method public setRadius(F)V
    ...
    invoke-interface {v0, v1, p1}, Landroid/support/v7/widget/s;->a(Landroid/support/v7/widget/r;F)V
...
.method public setUseCompatPadding(Z)V
    ...
    invoke-interface {v0, v1}, Landroid/support/v7/widget/s;->g(Landroid/support/v7/widget/r;)V
