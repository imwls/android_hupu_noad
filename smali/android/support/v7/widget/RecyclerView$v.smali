...
.method public a(IILandroid/view/animation/Interpolator;)V
    ...
    sget-object p3, Landroid/support/v7/widget/RecyclerView;->ah:Landroid/view/animation/Interpolator;
...
.method public run()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->E:Landroid/support/v7/widget/RecyclerView$LayoutManager;
    ...
    iget-object v15, v2, Landroid/support/v7/widget/RecyclerView$LayoutManager;->y:Landroid/support/v7/widget/RecyclerView$s;
    ...
    iget-object v3, v3, Landroid/support/v7/widget/RecyclerView;->v:Landroid/support/v7/widget/RecyclerView$o;
    ...
    invoke-virtual {v2, v10, v3, v4}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(ILandroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$t;)I
    ...
    iget-object v6, v6, Landroid/support/v7/widget/RecyclerView;->ab:Landroid/support/v7/widget/RecyclerView$t;

    invoke-virtual {v2, v9, v3, v6}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->b(ILandroid/support/v7/widget/RecyclerView$o;Landroid/support/v7/widget/RecyclerView$t;)I
    ...
    invoke-virtual {v6}, Landroid/support/v7/widget/RecyclerView;->C()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->G:Ljava/util/ArrayList;
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->aa:Landroid/support/v7/widget/ac$a;

    invoke-virtual {v2}, Landroid/support/v7/widget/ac$a;->a()V
    ...
    iget-object v2, v2, Landroid/support/v7/widget/RecyclerView;->W:Landroid/support/v7/widget/ac;
    ...
    invoke-virtual {v2, v3, v10, v9}, Landroid/support/v7/widget/ac;->a(Landroid/support/v7/widget/RecyclerView;II)V
