...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/as;->d:Landroid/support/v7/widget/RecyclerView$l;
...
.method private b()V
    ...
    iget-object v1, p0, Landroid/support/v7/widget/as;->d:Landroid/support/v7/widget/RecyclerView$l;
...
.method private b(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)Z
    ...
    .line 163
    :cond_1
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/as;->c(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/RecyclerView$s;
    ...
    .line 168
    invoke-virtual {p0, p1, p2, p3}, Landroid/support/v7/widget/as;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)I
    ...
    .line 174
    invoke-virtual {p1, v1}, Landroid/support/v7/widget/RecyclerView$LayoutManager;->a(Landroid/support/v7/widget/RecyclerView$s;)V
...
.method a()V
    ...
    .line 191
    invoke-virtual {p0, v0}, Landroid/support/v7/widget/as;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/view/View;
    ...
    .line 195
    invoke-virtual {p0, v0, v1}, Landroid/support/v7/widget/as;->a(Landroid/support/v7/widget/RecyclerView$LayoutManager;Landroid/view/View;)[I
    ...
    .line 197
    :cond_2
    iget-object v1, p0, Landroid/support/v7/widget/as;->b:Landroid/support/v7/widget/RecyclerView;
...
.method public a(Landroid/support/v7/widget/RecyclerView;)V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/as;->c:Landroid/widget/Scroller;
...
.method public a(II)Z
    ...
    .line 71
    :cond_1
    iget-object v2, p0, Landroid/support/v7/widget/as;->b:Landroid/support/v7/widget/RecyclerView;
    ...
    .line 77
    :cond_2
    invoke-direct {p0, v1, p1, p2}, Landroid/support/v7/widget/as;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;II)Z
...
.method protected b(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/LinearSmoothScroller;
    ...
    invoke-direct {v0, p0, v1}, Landroid/support/v7/widget/as$2;-><init>(Landroid/support/v7/widget/as;Landroid/content/Context;)V
...
.method public b(II)[I
    ...
    .line 140
    iget-object v0, p0, Landroid/support/v7/widget/as;->c:Landroid/widget/Scroller;
    ...
    iget-object v1, p0, Landroid/support/v7/widget/as;->c:Landroid/widget/Scroller;
...
.method protected c(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/RecyclerView$s;
    .locals 1
    .annotation build Landroid/support/annotation/ah;
    .end annotation
    ...
    .prologue
    .line 211
    invoke-virtual {p0, p1}, Landroid/support/v7/widget/as;->b(Landroid/support/v7/widget/RecyclerView$LayoutManager;)Landroid/support/v7/widget/LinearSmoothScroller;
