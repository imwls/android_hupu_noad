...
.field protected f:Landroid/support/v7/view/menu/o;

.field private g:Landroid/support/v7/view/menu/n$a;
...
.method public a(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/o;
    ...
    .prologue
    .line 76
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/o;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/o;

    .line 78
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->f:Landroid/support/v7/view/menu/o;

    iget-object v1, p0, Landroid/support/v7/view/menu/b;->c:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-interface {v0, v1}, Landroid/support/v7/view/menu/o;->a(Landroid/support/v7/view/menu/MenuBuilder;)V
...
.method public a(Landroid/support/v7/view/menu/j;Landroid/view/View;Landroid/view/ViewGroup;)Landroid/view/View;
    ...
    .prologue
    .line 182
    instance-of v0, p2, Landroid/support/v7/view/menu/o$a;

    if-eqz v0, :cond_0

    .line 183
    check-cast p2, Landroid/support/v7/view/menu/o$a;

    move-object v0, p2

    .line 187
    :goto_0
    invoke-virtual {p0, p1, v0}, Landroid/support/v7/view/menu/b;->a(Landroid/support/v7/view/menu/j;Landroid/support/v7/view/menu/o$a;)V
    ...
    .line 185
    :cond_0
    invoke-virtual {p0, p3}, Landroid/support/v7/view/menu/b;->b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/o$a;
...
.method public a(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;)V
    ...
    .line 71
    iput-object p2, p0, Landroid/support/v7/view/menu/b;->c:Landroid/support/v7/view/menu/MenuBuilder;
...
.method public a(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .prologue
    .line 212
    iget-object v0, p0, Landroid/support/v7/view/menu/b;->g:Landroid/support/v7/view/menu/n$a;
...
.method public abstract a(Landroid/support/v7/view/menu/j;Landroid/support/v7/view/menu/o$a;)V
.end method
...
.method public a(Landroid/support/v7/view/menu/n$a;)V
    ...
    .prologue
    .line 153
    iput-object p1, p0, Landroid/support/v7/view/menu/b;->g:Landroid/support/v7/view/menu/n$a;
...
.method public a(Z)V
    ...
    .line 102
    instance-of v2, v3, Landroid/support/v7/view/menu/o$a;

    if-eqz v2, :cond_4

    move-object v2, v3

    check-cast v2, Landroid/support/v7/view/menu/o$a;

    .line 103
    invoke-interface {v2}, Landroid/support/v7/view/menu/o$a;->getItemData()Landroid/support/v7/view/menu/j;
...
.method public b(Landroid/view/ViewGroup;)Landroid/support/v7/view/menu/o$a;
    .locals 3
...
.method public d()Landroid/support/v7/view/menu/n$a;
    .locals 1
