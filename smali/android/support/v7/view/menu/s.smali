...
.field private n:Landroid/support/v7/view/menu/n$a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/View;IIZ)V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/s;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/s;->k:Landroid/view/View$OnAttachStateChangeListener;
    ...
    .line 114
    iput-object p2, p0, Landroid/support/v7/view/menu/s;->d:Landroid/support/v7/view/menu/MenuBuilder;

    .line 115
    iput-boolean p6, p0, Landroid/support/v7/view/menu/s;->f:Z
    ...
    iget-boolean v2, p0, Landroid/support/v7/view/menu/s;->f:Z

    invoke-direct {v1, p2, v0, v2}, Landroid/support/v7/view/menu/g;-><init>(Landroid/support/v7/view/menu/MenuBuilder;Landroid/view/LayoutInflater;Z)V

    iput-object v1, p0, Landroid/support/v7/view/menu/s;->e:Landroid/support/v7/view/menu/g;

    .line 118
    iput p4, p0, Landroid/support/v7/view/menu/s;->h:I
    ...
    .line 125
    iput-object p3, p0, Landroid/support/v7/view/menu/s;->m:Landroid/view/View;
    ...
    iget v3, p0, Landroid/support/v7/view/menu/s;->h:I

    iget v4, p0, Landroid/support/v7/view/menu/s;->i:I
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/s;->a:Landroid/support/v7/widget/MenuPopupWindow;

    .line 130
    invoke-virtual {p2, p0, p1}, Landroid/support/v7/view/menu/MenuBuilder;->a(Landroid/support/v7/view/menu/n;Landroid/content/Context;)V
...
.method static synthetic a(Landroid/support/v7/view/menu/s;)Landroid/view/ViewTreeObserver;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->o:Landroid/view/ViewTreeObserver;
...
.method static synthetic a(Landroid/support/v7/view/menu/s;Landroid/view/ViewTreeObserver;)Landroid/view/ViewTreeObserver;
    ...
    .prologue
    .line 42
    iput-object p1, p0, Landroid/support/v7/view/menu/s;->o:Landroid/view/ViewTreeObserver;
...
.method static synthetic b(Landroid/support/v7/view/menu/s;)Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    .prologue
    .line 42
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
...
.method private j()Z
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->m:Landroid/view/View;
    ...
    .line 154
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    iput-object v4, p0, Landroid/support/v7/view/menu/s;->o:Landroid/view/ViewTreeObserver;
    ...
    iget-object v4, p0, Landroid/support/v7/view/menu/s;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;

    invoke-virtual {v0, v4}, Landroid/view/ViewTreeObserver;->addOnGlobalLayoutListener(Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;)V

    .line 164
    :cond_3
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->k:Landroid/view/View$OnAttachStateChangeListener;
    ...
    iget v4, p0, Landroid/support/v7/view/menu/s;->g:I
    ...
    .line 170
    iput-boolean v2, p0, Landroid/support/v7/view/menu/s;->q:Z
    ...
    invoke-virtual {p0}, Landroid/support/v7/view/menu/s;->i()Landroid/graphics/Rect;
    ...
    .line 181
    iget-boolean v0, p0, Landroid/support/v7/view/menu/s;->t:Z

    if-eqz v0, :cond_6

    iget-object v0, p0, Landroid/support/v7/view/menu/s;->d:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 187
    iget-object v5, p0, Landroid/support/v7/view/menu/s;->d:Landroid/support/v7/view/menu/MenuBuilder;
...
.method public a(I)V
    ...
    .prologue
    .line 140
    iput p1, p0, Landroid/support/v7/view/menu/s;->s:I
...
.method public a(Landroid/support/v7/view/menu/MenuBuilder;Z)V
    ...
    .line 291
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->n:Landroid/support/v7/view/menu/n$a;
    ...
    invoke-interface {v0, p1, p2}, Landroid/support/v7/view/menu/n$a;->a(Landroid/support/v7/view/menu/MenuBuilder;Z)V
...
.method public a(Landroid/support/v7/view/menu/n$a;)V
    ...
    .prologue
    .line 253
    iput-object p1, p0, Landroid/support/v7/view/menu/s;->n:Landroid/support/v7/view/menu/n$a;
...
.method public a(Landroid/view/View;)V
    ...
    .prologue
    .line 312
    iput-object p1, p0, Landroid/support/v7/view/menu/s;->m:Landroid/view/View;
...
.method public a(Landroid/widget/PopupWindow$OnDismissListener;)V
    ...
    .prologue
    .line 326
    iput-object p1, p0, Landroid/support/v7/view/menu/s;->l:Landroid/widget/PopupWindow$OnDismissListener;
...
.method public a(Landroid/support/v7/view/menu/t;)Z
    ...
    iget-boolean v4, p0, Landroid/support/v7/view/menu/s;->f:Z

    iget v5, p0, Landroid/support/v7/view/menu/s;->h:I

    iget v6, p0, Landroid/support/v7/view/menu/s;->i:I
    ...
    .line 261
    iget-object v1, p0, Landroid/support/v7/view/menu/s;->n:Landroid/support/v7/view/menu/n$a;

    invoke-virtual {v0, v1}, Landroid/support/v7/view/menu/m;->a(Landroid/support/v7/view/menu/n$a;)V
    ...
    iput-object v1, p0, Landroid/support/v7/view/menu/s;->l:Landroid/widget/PopupWindow$OnDismissListener;

    .line 270
    iget-object v1, p0, Landroid/support/v7/view/menu/s;->d:Landroid/support/v7/view/menu/MenuBuilder;

    invoke-virtual {v1, v7}, Landroid/support/v7/view/menu/MenuBuilder;->c(Z)V

    .line 273
    iget-object v1, p0, Landroid/support/v7/view/menu/s;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    .line 274
    iget-object v2, p0, Landroid/support/v7/view/menu/s;->a:Landroid/support/v7/widget/MenuPopupWindow;
    ...
    .line 275
    invoke-virtual {v0, v1, v2}, Landroid/support/v7/view/menu/m;->b(II)Z
...
.method public c(Z)V
    ...
    .prologue
    .line 347
    iput-boolean p1, p0, Landroid/support/v7/view/menu/s;->t:Z
...
.method public d()V
    ...
    .prologue
    .line 203
    invoke-direct {p0}, Landroid/support/v7/view/menu/s;->j()Z
...
.method public onDismiss()V
    ...
    iput-object v0, p0, Landroid/support/v7/view/menu/s;->o:Landroid/view/ViewTreeObserver;

    .line 232
    :cond_0
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->o:Landroid/view/ViewTreeObserver;

    iget-object v1, p0, Landroid/support/v7/view/menu/s;->j:Landroid/view/ViewTreeObserver$OnGlobalLayoutListener;
    ...
    iget-object v1, p0, Landroid/support/v7/view/menu/s;->k:Landroid/view/View$OnAttachStateChangeListener;

    invoke-virtual {v0, v1}, Landroid/view/View;->removeOnAttachStateChangeListener(Landroid/view/View$OnAttachStateChangeListener;)V

    .line 237
    iget-object v0, p0, Landroid/support/v7/view/menu/s;->l:Landroid/widget/PopupWindow$OnDismissListener;
