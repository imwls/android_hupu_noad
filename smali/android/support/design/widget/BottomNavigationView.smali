...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->d:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    .line 134
    iget-object v1, p0, Landroid/support/design/widget/BottomNavigationView;->d:Landroid/support/v7/view/menu/MenuBuilder;

    iget-object v2, p0, Landroid/support/design/widget/BottomNavigationView;->f:Landroid/support/design/internal/BottomNavigationPresenter;

    invoke-virtual {v1, v2}, Landroid/support/v7/view/menu/MenuBuilder;->a(Landroid/support/v7/view/menu/n;)V
    ...
    iget-object v3, p0, Landroid/support/design/widget/BottomNavigationView;->d:Landroid/support/v7/view/menu/MenuBuilder;
    ...
    invoke-static {p1, p2, v1, p3, v2}, Landroid/support/v7/widget/ay;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Landroid/support/v7/widget/ay;
    ...
    .line 144
    invoke-virtual {v1, v3}, Landroid/support/v7/widget/ay;->g(I)Landroid/content/res/ColorStateList;
    ...
    invoke-virtual {v1, v2, v4}, Landroid/support/v7/widget/ay;->e(II)I

    move-result v2

    int-to-float v2, v2

    invoke-static {p0, v2}, Landroid/support/v4/view/x;->m(Landroid/view/View;F)V

    .line 161
    :cond_0
    sget v2, Landroid/support/design/R$styleable;->BottomNavigationView_itemBackground:I

    invoke-virtual {v1, v2, v4}, Landroid/support/v7/widget/ay;->g(II)I
    ...
    .line 174
    :cond_2
    iget-object v0, p0, Landroid/support/design/widget/BottomNavigationView;->d:Landroid/support/v7/view/menu/MenuBuilder;
