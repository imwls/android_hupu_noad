...
.method constructor <init>(Landroid/support/design/internal/a;)V
    ...
    iput-object v0, p0, Landroid/support/design/internal/a$b;->h:Ljava/util/ArrayList;
...
.method private c()V
    ...
    .prologue
    .line 469
    iget-boolean v0, p0, Landroid/support/design/internal/a$b;->j:Z
    ...
    iput-boolean v0, p0, Landroid/support/design/internal/a$b;->j:Z
    ...
    new-instance v1, Landroid/support/design/internal/a$c;

    invoke-direct {v1}, Landroid/support/design/internal/a$c;-><init>()V
    ...
    .line 482
    invoke-virtual {p0, v0}, Landroid/support/design/internal/a$b;->a(Landroid/support/v7/view/menu/j;)V
    ...
    .line 491
    iget-object v1, p0, Landroid/support/design/internal/a$b;->h:Ljava/util/ArrayList;

    new-instance v2, Landroid/support/design/internal/a$e;

    iget-object v6, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget v6, v6, Landroid/support/design/internal/a;->j:I

    const/4 v10, 0x0

    invoke-direct {v2, v6, v10}, Landroid/support/design/internal/a$e;-><init>(II)V
    ...
    new-instance v2, Landroid/support/design/internal/a$f;

    invoke-direct {v2, v0}, Landroid/support/design/internal/a$f;-><init>(Landroid/support/v7/view/menu/j;)V
    ...
    .line 508
    :cond_6
    iget-object v12, p0, Landroid/support/design/internal/a$b;->h:Ljava/util/ArrayList;

    new-instance v13, Landroid/support/design/internal/a$f;

    invoke-direct {v13, v1}, Landroid/support/design/internal/a$f;-><init>(Landroid/support/v7/view/menu/j;)V
    ...
    invoke-direct {p0, v10, v0}, Landroid/support/design/internal/a$b;->a(II)V
    ...
    new-instance v4, Landroid/support/design/internal/a$e;

    iget-object v5, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget v5, v5, Landroid/support/design/internal/a;->j:I

    iget-object v9, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget v9, v9, Landroid/support/design/internal/a;->j:I

    invoke-direct {v4, v5, v9}, Landroid/support/design/internal/a$e;-><init>(II)V
    ...
    :cond_b
    :goto_5
    new-instance v3, Landroid/support/design/internal/a$f;

    invoke-direct {v3, v0}, Landroid/support/design/internal/a$f;-><init>(Landroid/support/v7/view/menu/j;)V

    .line 530
    iput-boolean v1, v3, Landroid/support/design/internal/a$f;->a:Z
    ...
    invoke-direct {p0, v4, v2}, Landroid/support/design/internal/a$b;->a(II)V
...
.method public a(Landroid/view/ViewGroup;I)Landroid/support/design/internal/a$j;
    ...
    .line 402
    :pswitch_0
    new-instance v0, Landroid/support/design/internal/a$g;

    iget-object v1, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget-object v1, v1, Landroid/support/design/internal/a;->d:Landroid/view/LayoutInflater;

    iget-object v2, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget-object v2, v2, Landroid/support/design/internal/a;->k:Landroid/view/View$OnClickListener;

    invoke-direct {v0, v1, p1, v2}, Landroid/support/design/internal/a$g;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;Landroid/view/View$OnClickListener;)V

    goto :goto_0

    .line 404
    :pswitch_1
    new-instance v0, Landroid/support/design/internal/a$i;

    iget-object v1, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget-object v1, v1, Landroid/support/design/internal/a;->d:Landroid/view/LayoutInflater;

    invoke-direct {v0, v1, p1}, Landroid/support/design/internal/a$i;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V

    goto :goto_0

    .line 406
    :pswitch_2
    new-instance v0, Landroid/support/design/internal/a$h;

    iget-object v1, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget-object v1, v1, Landroid/support/design/internal/a;->d:Landroid/view/LayoutInflater;

    invoke-direct {v0, v1, p1}, Landroid/support/design/internal/a$h;-><init>(Landroid/view/LayoutInflater;Landroid/view/ViewGroup;)V

    goto :goto_0

    .line 408
    :pswitch_3
    new-instance v0, Landroid/support/design/internal/a$a;

    iget-object v1, p0, Landroid/support/design/internal/a$b;->a:Landroid/support/design/internal/a;

    iget-object v1, v1, Landroid/support/design/internal/a;->a:Landroid/widget/LinearLayout;

    invoke-direct {v0, v1}, Landroid/support/design/internal/a$a;-><init>(Landroid/view/View;)V
...
.method public a(Landroid/os/Bundle;)V
    ...
    check-cast v0, Landroid/support/design/internal/a$d;

    .line 585
    instance-of v5, v0, Landroid/support/design/internal/a$f;
    ...
    invoke-virtual {v0}, Landroid/support/design/internal/a$f;->a()Landroid/support/v7/view/menu/j;
    ...
    .line 602
    instance-of v4, v0, Landroid/support/design/internal/a$f;
...
.method public a(Landroid/support/design/internal/a$j;)V
    ...
    .line 455
    iget-object v0, p1, Landroid/support/design/internal/a$j;->itemView:Landroid/view/View;
...
.method public a(Landroid/support/design/internal/a$j;I)V
    ...
    iget-object v1, v1, Landroid/support/design/internal/a;->h:Landroid/content/res/ColorStateList;
    ...
    iget-boolean v1, v1, Landroid/support/design/internal/a;->f:Z
    ...
    iget v1, v1, Landroid/support/design/internal/a;->e:I
    ...
    iget-object v1, v1, Landroid/support/design/internal/a;->g:Landroid/content/res/ColorStateList;
    ...
    iget-object v1, v1, Landroid/support/design/internal/a;->i:Landroid/graphics/drawable/Drawable;
    ...
    check-cast v1, Landroid/support/design/internal/a$f;

    .line 428
    iget-boolean v2, v1, Landroid/support/design/internal/a$f;->a:Z

    invoke-virtual {v0, v2}, Landroid/support/design/internal/NavigationMenuItemView;->setNeedsEmptyIcon(Z)V

    .line 429
    invoke-virtual {v1}, Landroid/support/design/internal/a$f;->a()Landroid/support/v7/view/menu/j;
    ...
    check-cast v0, Landroid/support/design/internal/a$e;

    .line 441
    iget-object v1, p1, Landroid/support/design/internal/a$j;->itemView:Landroid/view/View;

    invoke-virtual {v0}, Landroid/support/design/internal/a$e;->a()I

    move-result v2

    .line 442
    invoke-virtual {v0}, Landroid/support/design/internal/a$e;->b()I
...
.method public a(Landroid/support/v7/view/menu/j;)V
    ...
    .prologue
    .line 546
    iget-object v0, p0, Landroid/support/design/internal/a$b;->i:Landroid/support/v7/view/menu/j;
    ...
    .line 552
    :cond_2
    iput-object p1, p0, Landroid/support/design/internal/a$b;->i:Landroid/support/v7/view/menu/j;
...
.method public b()Landroid/os/Bundle;
    ...
    iget-object v1, p0, Landroid/support/design/internal/a$b;->i:Landroid/support/v7/view/menu/j;
...
.method public getItemViewType(I)I
    ...
    .line 383
    instance-of v1, v0, Landroid/support/design/internal/a$e;
    ...
    .line 385
    :cond_0
    instance-of v1, v0, Landroid/support/design/internal/a$c;
    ...
    .line 387
    :cond_1
    instance-of v1, v0, Landroid/support/design/internal/a$f;
