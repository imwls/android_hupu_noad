...
.method public constructor <init>(Landroid/arch/lifecycle/g;)V
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/h;->b:Landroid/arch/a/b/a;

    .line 74
    iput v1, p0, Landroid/arch/lifecycle/h;->e:I

    .line 76
    iput-boolean v1, p0, Landroid/arch/lifecycle/h;->f:Z

    .line 77
    iput-boolean v1, p0, Landroid/arch/lifecycle/h;->g:Z
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/h;->h:Ljava/util/ArrayList;
    ...
    iput-object v0, p0, Landroid/arch/lifecycle/h;->d:Ljava/lang/ref/WeakReference;

    .line 99
    sget-object v0, Landroid/arch/lifecycle/Lifecycle$State;->INITIALIZED:Landroid/arch/lifecycle/Lifecycle$State;

    iput-object v0, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;
...
.method private a(Landroid/arch/lifecycle/g;)V
    ...
    .prologue
    .line 284
    iget-object v0, p0, Landroid/arch/lifecycle/h;->b:Landroid/arch/a/b/a;
    ...
    iget-boolean v0, p0, Landroid/arch/lifecycle/h;->g:Z
    ...
    iget-object v4, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-boolean v3, p0, Landroid/arch/lifecycle/h;->g:Z

    if-nez v3, :cond_0

    iget-object v3, p0, Landroid/arch/lifecycle/h;->b:Landroid/arch/a/b/a;
...
.method private b(Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 127
    iget-object v0, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 130
    :cond_0
    iput-object p1, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget v0, p0, Landroid/arch/lifecycle/h;->e:I
    ...
    .line 137
    invoke-direct {p0}, Landroid/arch/lifecycle/h;->e()V
...
.method private c(Landroid/arch/lifecycle/f;)Landroid/arch/lifecycle/Lifecycle$State;
    ...
    .line 154
    :goto_0
    iget-object v0, p0, Landroid/arch/lifecycle/h;->h:Ljava/util/ArrayList;
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/h;->h:Ljava/util/ArrayList;
    ...
    .line 156
    :goto_1
    iget-object v2, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {v2, v1}, Landroid/arch/lifecycle/h;->a(Landroid/arch/lifecycle/Lifecycle$State;Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$State;
...
.method private d()V
    ...
    iget-object v1, p0, Landroid/arch/lifecycle/h;->h:Ljava/util/ArrayList;
...
.method private e()V
    ...
    .line 317
    iget-object v0, p0, Landroid/arch/lifecycle/h;->d:Ljava/lang/ref/WeakReference;
    ...
    :cond_0
    :goto_1
    invoke-direct {p0}, Landroid/arch/lifecycle/h;->c()Z
    ...
    .line 324
    iput-boolean v3, p0, Landroid/arch/lifecycle/h;->g:Z

    .line 326
    iget-object v2, p0, Landroid/arch/lifecycle/h;->c:Landroid/arch/lifecycle/Lifecycle$State;

    iget-object v1, p0, Landroid/arch/lifecycle/h;->b:Landroid/arch/a/b/a;
    ...
    .line 330
    iget-boolean v2, p0, Landroid/arch/lifecycle/h;->g:Z
...
.method public a(Landroid/arch/lifecycle/f;)V
    ...
    invoke-direct {v3, p1, v0}, Landroid/arch/lifecycle/h$a;-><init>(Landroid/arch/lifecycle/f;Landroid/arch/lifecycle/Lifecycle$State;)V
    ...
    .line 174
    iget v1, p0, Landroid/arch/lifecycle/h;->e:I
    ...
    .line 176
    iget v4, p0, Landroid/arch/lifecycle/h;->e:I

    add-int/lit8 v4, v4, 0x1

    iput v4, p0, Landroid/arch/lifecycle/h;->e:I

    .line 177
    :goto_3
    iget-object v4, v3, Landroid/arch/lifecycle/h$a;->a:Landroid/arch/lifecycle/Lifecycle$State;
    ...
    iget-object v2, p0, Landroid/arch/lifecycle/h;->b:Landroid/arch/a/b/a;
    ...
    .line 179
    iget-object v2, v3, Landroid/arch/lifecycle/h$a;->a:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-direct {p0, v2}, Landroid/arch/lifecycle/h;->c(Landroid/arch/lifecycle/Lifecycle$State;)V

    .line 180
    iget-object v2, v3, Landroid/arch/lifecycle/h$a;->a:Landroid/arch/lifecycle/Lifecycle$State;

    invoke-static {v2}, Landroid/arch/lifecycle/h;->e(Landroid/arch/lifecycle/Lifecycle$State;)Landroid/arch/lifecycle/Lifecycle$Event;

    move-result-object v2

    invoke-virtual {v3, v0, v2}, Landroid/arch/lifecycle/h$a;->a(Landroid/arch/lifecycle/g;Landroid/arch/lifecycle/Lifecycle$Event;)V
    ...
    iput v0, p0, Landroid/arch/lifecycle/h;->e:I
