.class public final Lcn/shihuo/modulelib/views/dialogs/f;
...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lcn/shihuo/modulelib/views/dialogs/f$a;
    }
.end annotation
...
.annotation runtime Lkotlin/q;
    ...
    e = {
        "Lcn/shihuo/modulelib/views/dialogs/PrefectureOrderPop;",
        "",
        "context",
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/List;I)V
    ...
    .line 21
    iput-object p2, p0, Lcn/shihuo/modulelib/views/dialogs/f;->a:Ljava/util/List;

    .line 22
    iput p3, p0, Lcn/shihuo/modulelib/views/dialogs/f;->b:I

    .line 23
    sget-object v0, Lcn/shihuo/modulelib/views/dialogs/PrefectureOrderPop$confirm$1;->INSTANCE:Lcn/shihuo/modulelib/views/dialogs/PrefectureOrderPop$confirm$1;

    check-cast v0, Lkotlin/jvm/a/b;

    iput-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->c:Lkotlin/jvm/a/b;
    ...
    iput-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->d:Lcn/shihuo/modulelib/views/CustomPopWindow;

    .line 29
    iget-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->d:Lcn/shihuo/modulelib/views/CustomPopWindow;
    ...
    iput-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->e:Landroid/view/View;

    .line 31
    iget-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->e:Landroid/view/View;
    ...
    .line 32
    new-instance v1, Lcn/shihuo/modulelib/views/dialogs/f$a;

    invoke-direct {v1, p0}, Lcn/shihuo/modulelib/views/dialogs/f$a;-><init>(Lcn/shihuo/modulelib/views/dialogs/f;)V
...
.method public synthetic constructor <init>(Landroid/content/Context;Ljava/util/List;IILkotlin/jvm/internal/t;)V
    ...
    :cond_0
    invoke-direct {p0, p1, v0, p3}, Lcn/shihuo/modulelib/views/dialogs/f;-><init>(Landroid/content/Context;Ljava/util/List;I)V
...
.method public static final synthetic a(Lcn/shihuo/modulelib/views/dialogs/f;)Lcn/shihuo/modulelib/views/CustomPopWindow;
    .locals 1
...
.method public static bridge synthetic a(Lcn/shihuo/modulelib/views/dialogs/f;Landroid/view/View;IIILjava/lang/Object;)V
    .locals 2
    ...
    :cond_1
    invoke-virtual {p0, p1, p2, p3}, Lcn/shihuo/modulelib/views/dialogs/f;->a(Landroid/view/View;II)V

    return-void
.end method

.method public static final synthetic a(Lcn/shihuo/modulelib/views/dialogs/f;Lcn/shihuo/modulelib/views/CustomPopWindow;)V
    .locals 0
    ...
    .prologue
    .line 20
    iput-object p1, p0, Lcn/shihuo/modulelib/views/dialogs/f;->d:Lcn/shihuo/modulelib/views/CustomPopWindow;

    return-void
.end method

.method public static final synthetic a(Lcn/shihuo/modulelib/views/dialogs/f;Lkotlin/jvm/a/b;)V
    .locals 0
    ...
    .prologue
    .line 20
    iput-object p1, p0, Lcn/shihuo/modulelib/views/dialogs/f;->c:Lkotlin/jvm/a/b;

    return-void
.end method

.method public static final synthetic b(Lcn/shihuo/modulelib/views/dialogs/f;)Lkotlin/jvm/a/b;
    .locals 1
    .annotation build Lorg/b/a/d;
    .end annotation
    ...
    .prologue
    .line 20
    iget-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->c:Lkotlin/jvm/a/b;
...
.method public final a()Ljava/util/List;
    ...
    .prologue
    .line 21
    iget-object v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->a:Ljava/util/List;
...
.method public final a(I)V
    ...
    .prologue
    .line 22
    iput p1, p0, Lcn/shihuo/modulelib/views/dialogs/f;->b:I
...
.method public final a(Landroid/view/View;II)V
    ...
    .line 57
    new-instance v0, Lcn/shihuo/modulelib/views/dialogs/f$b;

    invoke-direct {v0, p0, p1, p3}, Lcn/shihuo/modulelib/views/dialogs/f$b;-><init>(Lcn/shihuo/modulelib/views/dialogs/f;Landroid/view/View;I)V
...
.method public final a(Ljava/util/List;)V
    ...
    .prologue
    .line 21
    iput-object p1, p0, Lcn/shihuo/modulelib/views/dialogs/f;->a:Ljava/util/List;
...
.method public final b()I
    ...
    .prologue
    .line 22
    iget v0, p0, Lcn/shihuo/modulelib/views/dialogs/f;->b:I

    return v0
.end method

.method public final b(Lkotlin/jvm/a/b;)Lcn/shihuo/modulelib/views/dialogs/f;
    .locals 1
    .param p1    # Lkotlin/jvm/a/b;
        .annotation build Lorg/b/a/d;
        .end annotation
    ...
    .annotation system Ldalvik/annotation/Signature;
        value = {
            ...
            "Lkotlin/ag;",
            ">;)",
            "Lcn/shihuo/modulelib/views/dialogs/f;"
        }
    .end annotation
