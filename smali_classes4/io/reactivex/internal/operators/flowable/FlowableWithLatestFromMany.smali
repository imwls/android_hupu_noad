...
.method public constructor <init>(Lio/reactivex/j;Ljava/lang/Iterable;Lio/reactivex/c/h;)V
    ...
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Lorg/c/b;
...
.method public constructor <init>(Lio/reactivex/j;[Lorg/c/b;Lio/reactivex/c/h;)V
    .locals 1
    .param p1    # Lio/reactivex/j;
        .annotation build Lio/reactivex/annotations/e;
        .end annotation
    ...
    .line 48
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Lorg/c/b;
...
.method protected d(Lorg/c/c;)V
    ...
    .prologue
    .line 62
    iget-object v1, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->c:[Lorg/c/b;
    ...
    invoke-direct {v0, v1, v2}, Lio/reactivex/internal/operators/flowable/ar;-><init>(Lio/reactivex/j;Lio/reactivex/c/h;)V

    invoke-virtual {v0, p1}, Lio/reactivex/internal/operators/flowable/ar;->d(Lorg/c/c;)V
    ...
    invoke-direct {v2, p1, v3, v0}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;-><init>(Lorg/c/c;Lio/reactivex/c/h;I)V

    .line 90
    invoke-interface {p1, v2}, Lorg/c/c;->onSubscribe(Lorg/c/d;)V

    .line 91
    invoke-virtual {v2, v1, v0}, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany$WithLatestFromSubscriber;->subscribe([Lorg/c/b;I)V

    .line 93
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableWithLatestFromMany;->b:Lio/reactivex/j;

    invoke-virtual {v0, v2}, Lio/reactivex/j;->a(Lio/reactivex/o;)V
