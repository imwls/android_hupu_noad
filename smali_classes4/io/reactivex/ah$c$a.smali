...
.method public run()V
    ...
    invoke-virtual {v0, v1}, Lio/reactivex/ah$c;->a(Ljava/util/concurrent/TimeUnit;)J
    ...
    iget-wide v0, p0, Lio/reactivex/ah$c$a;->e:J

    iget-wide v4, p0, Lio/reactivex/ah$c$a;->c:J

    add-long/2addr v0, v4

    sget-wide v4, Lio/reactivex/ah;->a:J
    ...
    .line 381
    :cond_0
    iget-wide v0, p0, Lio/reactivex/ah$c$a;->c:J
    ...
    iget-wide v6, p0, Lio/reactivex/ah$c$a;->d:J

    add-long/2addr v6, v8

    iput-wide v6, p0, Lio/reactivex/ah$c$a;->d:J

    mul-long/2addr v4, v6

    sub-long v4, v0, v4

    iput-wide v4, p0, Lio/reactivex/ah$c$a;->f:J

    .line 390
    :goto_0
    iput-wide v2, p0, Lio/reactivex/ah$c$a;->e:J

    .line 392
    sub-long/2addr v0, v2

    .line 393
    iget-object v2, p0, Lio/reactivex/ah$c$a;->b:Lio/reactivex/internal/disposables/SequentialDisposable;

    iget-object v3, p0, Lio/reactivex/ah$c$a;->g:Lio/reactivex/ah$c;

    sget-object v4, Ljava/util/concurrent/TimeUnit;->NANOSECONDS:Ljava/util/concurrent/TimeUnit;

    invoke-virtual {v3, p0, v0, v1, v4}, Lio/reactivex/ah$c;->a(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;)Lio/reactivex/disposables/b;
    ...
    .line 388
    :cond_2
    iget-wide v0, p0, Lio/reactivex/ah$c$a;->f:J
