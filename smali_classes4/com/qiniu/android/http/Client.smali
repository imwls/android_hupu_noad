...
.field private httpClient:Lokhttp3/ab;
...
.method public constructor <init>(Lcom/qiniu/android/http/ProxyConfiguration;IILcom/qiniu/android/http/UrlConverter;Lcom/qiniu/android/dns/DnsManager;)V
    ...
    invoke-virtual {v0, v1}, Lokhttp3/ab$a;->b(Lokhttp3/b;)Lokhttp3/ab$a;
    ...
    invoke-virtual {v0, v1}, Lokhttp3/ab$a;->a(Lokhttp3/q;)Lokhttp3/ab$a;

    .line 81
    :cond_1
    invoke-virtual {v0}, Lokhttp3/ab$a;->b()Ljava/util/List;
    ...
    iput-object v0, p0, Lcom/qiniu/android/http/Client;->httpClient:Lokhttp3/ab;

    .line 107
    return-void
.end method

.method static synthetic access$100(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
    .locals 0

    .prologue
    .line 39
    invoke-static/range {p0 .. p5}, Lcom/qiniu/android/http/Client;->onRet(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V

    return-void
.end method

.method private asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/ProgressHandler;Ljava/lang/String;Lokhttp3/af;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    .locals 2
    ...
    invoke-virtual {v0, v1, p5, p6}, Lokhttp3/aa$a;->a(Ljava/lang/String;Ljava/lang/String;Lokhttp3/af;)Lokhttp3/aa$a;

    .line 301
    new-instance v1, Lcom/qiniu/android/http/Client$6;

    invoke-direct {v1, p0, v0}, Lcom/qiniu/android/http/Client$6;-><init>(Lcom/qiniu/android/http/Client;Lokhttp3/aa$a;)V
    ...
    invoke-direct {v1, v0, p4, p8}, Lcom/qiniu/android/http/CountingRequestBody;-><init>(Lokhttp3/af;Lcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    invoke-virtual {v1, v0}, Lokhttp3/ae$a;->a(Lokhttp3/af;)Lokhttp3/ae$a;
    ...
    invoke-virtual {p0, v0, v1, p3, p7}, Lcom/qiniu/android/http/Client;->asyncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
...
.method private static buildResponseInfo(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 20

    .prologue
    .line 143
    invoke-virtual/range {p0 .. p0}, Lokhttp3/ag;->c()I
    ...
    invoke-virtual {v0, v2}, Lokhttp3/ag;->b(Ljava/lang/String;)Ljava/lang/String;
    ...
    .line 149
    :try_start_0
    invoke-virtual/range {p0 .. p0}, Lokhttp3/ag;->h()Lokhttp3/ah;

    move-result-object v6

    invoke-virtual {v6}, Lokhttp3/ah;->bytes()[B
    :try_end_0
    ...
    .line 154
    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->ctype(Lokhttp3/ag;)Ljava/lang/String;
    ...
    .line 170
    :goto_2
    invoke-virtual/range {p0 .. p0}, Lokhttp3/ag;->a()Lokhttp3/ae;

    move-result-object v2

    invoke-virtual {v2}, Lokhttp3/ae;->a()Lokhttp3/v;
    ...
    invoke-virtual {v0, v6}, Lokhttp3/ag;->b(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v6

    .line 172
    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->via(Lokhttp3/ag;)Ljava/lang/String;
    ...
    invoke-virtual {v2}, Lokhttp3/v;->l()Ljava/lang/String;

    move-result-object v9

    invoke-virtual {v2}, Lokhttp3/v;->j()I

    move-result v11

    invoke-static/range {p0 .. p0}, Lcom/qiniu/android/http/Client;->getContentLength(Lokhttp3/ag;)J
...
.method private static ctype(Lokhttp3/ag;)Ljava/lang/String;
    .locals 3
...
.method private static getContentLength(Lokhttp3/ag;)J
    .locals 2
...
.method private static onRet(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
    .locals 2

    .prologue
    .line 189
    invoke-static {p0, p1, p2, p3, p4}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
...
.method private send(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 18
    ...
    invoke-direct {v2, v0, v1}, Lcom/qiniu/android/http/Client$7;-><init>(Lcom/qiniu/android/http/Client;Lokhttp3/ae$a;)V
    ...
    invoke-virtual {v0, v2, v3}, Lokhttp3/ae$a;->a(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/ae$a;
    ...
    invoke-virtual {v0, v12}, Lokhttp3/ae$a;->a(Ljava/lang/Object;)Lokhttp3/ae$a;
    ...
    iget-object v2, v0, Lcom/qiniu/android/http/Client;->httpClient:Lokhttp3/ab;

    invoke-virtual {v2, v11}, Lokhttp3/ab;->a(Lokhttp3/ae;)Lokhttp3/e;

    move-result-object v2

    invoke-interface {v2}, Lokhttp3/e;->b()Lokhttp3/ag;
    :try_end_0
    .catch Ljava/io/IOException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-static {v2, v3, v4, v5, v6}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    ...
    invoke-virtual {v8}, Lokhttp3/v;->i()Ljava/lang/String;
    ...
    invoke-virtual {v9}, Lokhttp3/v;->l()Ljava/lang/String;
    ...
    invoke-virtual {v11}, Lokhttp3/v;->j()I
...
.method private syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Ljava/lang/String;Lokhttp3/af;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 2
    ...
    invoke-virtual {v0, v1, p4, p5}, Lokhttp3/aa$a;->a(Ljava/lang/String;Ljava/lang/String;Lokhttp3/af;)Lokhttp3/aa$a;

    .line 373
    new-instance v1, Lcom/qiniu/android/http/Client$8;

    invoke-direct {v1, p0, v0}, Lcom/qiniu/android/http/Client$8;-><init>(Lcom/qiniu/android/http/Client;Lokhttp3/aa$a;)V
    ...
    invoke-virtual {p0, v0, v1, p3}, Lcom/qiniu/android/http/Client;->syncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
...
.method private static via(Lokhttp3/ag;)Ljava/lang/String;
    .locals 2
    ...
    invoke-virtual {p0, v0, v1}, Lokhttp3/ag;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public asyncGet(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
    ...
    .line 318
    invoke-virtual {p0, v0, p2, p3, p4}, Lcom/qiniu/android/http/Client;->asyncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
...
.method public asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/http/PostArgs;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    invoke-direct/range {v0 .. v8}, Lcom/qiniu/android/http/Client;->asyncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/ProgressHandler;Ljava/lang/String;Lokhttp3/af;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
...
.method public asyncPost(Ljava/lang/String;[BIILcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CompletionHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    .line 260
    invoke-static {v0, p2, p3, p4}, Lokhttp3/af;->create(Lokhttp3/z;[BII)Lokhttp3/af;
    ...
    invoke-direct {v1, v0, p7, p9}, Lcom/qiniu/android/http/CountingRequestBody;-><init>(Lokhttp3/af;Lcom/qiniu/android/http/ProgressHandler;Lcom/qiniu/android/http/CancellationHandler;)V
    ...
    .line 269
    invoke-virtual {p0, v0, p5, p6, p8}, Lcom/qiniu/android/http/Client;->asyncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
...
.method public asyncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Lcom/qiniu/android/http/CompletionHandler;)V
    .locals 3
    ...
    invoke-direct {v0, p0, p1}, Lcom/qiniu/android/http/Client$4;-><init>(Lcom/qiniu/android/http/Client;Lokhttp3/ae$a;)V
    ...
    invoke-virtual {p1, v0, v1}, Lokhttp3/ae$a;->a(Ljava/lang/String;Ljava/lang/String;)Lokhttp3/ae$a;
    ...
    .line 211
    iget-object v1, p0, Lcom/qiniu/android/http/Client;->httpClient:Lokhttp3/ab;

    invoke-virtual {p1, v0}, Lokhttp3/ae$a;->a(Ljava/lang/Object;)Lokhttp3/ae$a;
    ...
    invoke-virtual {v1, v2}, Lokhttp3/ab;->a(Lokhttp3/ae;)Lokhttp3/e;
...
.method public syncGet(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
    ...
    .line 323
    invoke-direct {p0, v0, p2}, Lcom/qiniu/android/http/Client;->send(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;)Lcom/qiniu/android/http/ResponseInfo;
...
.method public syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/http/PostArgs;Lcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    ...
    invoke-direct/range {v0 .. v5}, Lcom/qiniu/android/http/Client;->syncMultipartPost(Ljava/lang/String;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;Ljava/lang/String;Lokhttp3/af;)Lcom/qiniu/android/http/ResponseInfo;
...
.method public syncSend(Lokhttp3/ae$a;Lcom/qiniu/android/utils/StringMap;Lcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    .locals 18
    ...
    invoke-direct {v2, v0, v1}, Lcom/qiniu/android/http/Client$9;-><init>(Lcom/qiniu/android/http/Client;Lokhttp3/ae$a;)V
    ...
    iget-object v4, v0, Lcom/qiniu/android/http/Client;->httpClient:Lokhttp3/ab;
    ...
    invoke-static {v4, v5, v6, v7, v0}, Lcom/qiniu/android/http/Client;->buildResponseInfo(Lokhttp3/ag;Ljava/lang/String;JLcom/qiniu/android/storage/UpToken;)Lcom/qiniu/android/http/ResponseInfo;
    :try_end_0
    ...
    invoke-virtual {v11}, Lokhttp3/v;->i()Ljava/lang/String;

    move-result-object v8

    invoke-virtual {v11}, Lokhttp3/v;->l()Ljava/lang/String;
